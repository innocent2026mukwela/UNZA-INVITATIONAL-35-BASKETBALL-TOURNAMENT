...
const LINKS = ['Home','About','Gallery','Schedule','Register','Sponsors'];
  ...
  return (
    <nav
      className={`fixed top-0 inset-x-0 z-50 transition-all duration-500 ${
        scrolled
          ? 'bg-black/90 shadow-[0_1px_0_rgba(232,0,13,0.2)]'
          : 'bg-transparent'
      }`}
    ...
    >
      <div className="max-w-7xl mx-auto px-5 sm:px-8 flex items-center justify-between h-[70px]">
        ...
        <a href="#home" className="flex items-center gap-3 group">
          <div
            className="flex-shrink-0 w-10 h-10 rounded-full overflow-hidden border-2 border-[#e8000d] transition-all duration-300 group-hover:scale-110"
          ...
          <div className="leading-none">
            <div className="font-['Bebas_Neue'] text-xl tracking-[3px] text-white">UNZA <span className="text-[#e8000d]">ALUMNI</span></div>
            <div className="font-['Barlow_Condensed'] text-xs tracking-[3px] text-white/80 font-bold uppercase">+35 Fundraiser Tournament 2026</div>
          </div>
        </a>
